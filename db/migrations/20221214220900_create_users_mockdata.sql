...
INSERT INTO user_group (company_name, start_date, end_date) VALUES ('amazon', '2022-12-23', '2022-01-31');
...
INSERT INTO users (nickname, password, email, position_name, is_admin, group_id) VALUES ('member4', '$2a$10$HnYarW5RUCdMRQJzb.bWguMwL9G9yR5kUc82jifCEQhZZSl/5Fk4K', 'member4@test.com', '주임', TRUE, 3);
#퇴주자
INSERT INTO users (nickname, password, email, position_name, is_admin, group_id) VALUES ('member6exit', '$2a$10$BIFBNVZ2p2Zk0wL1ueQEBu7wGvtfVYfK5DLkEyXPBHFm6iOaoFMPG', 'member6@test.com', '사원',FALSE, 2);
...
#일반가입자
INSERT INTO users (nickname, password, email, position_name, is_admin, group_id) VALUES ('normal1', '$2a$10$HSnJV56pEEaT8C7hniwL/eb5j7vKtrjEyOghXJS2fMA0LHbRBOOU.', 'normal1@test.com', '대표', TRUE, 6);
-- migrate:down
