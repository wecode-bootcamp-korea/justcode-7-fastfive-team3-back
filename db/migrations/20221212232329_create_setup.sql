...
insert into branch (id, branch_name) values (1,'강남1호점');
insert into branch (id, branch_name) values (2, '강남2호점');
insert into branch (id, branch_name) values (3, '강남3호점');
insert into branch (id, branch_name) values (4, '강남4호점');
insert into branch (id, branch_name) values (5, '강남5호점');
insert into branch (id, branch_name) values (6,'광화문점');
insert into branch (id, branch_name) values (7,'교대점');
insert into branch (id, branch_name) values (8,'구로1호점');
insert into branch (id, branch_name) values (9,'명동1호점');
insert into branch (id, branch_name) values (10,'삼성1호점');
insert into branch (id, branch_name) values (11,'삼성2호점');
insert into branch (id, branch_name) values (12,'삼성3호점');
insert into branch (id, branch_name) values (13,'삼성4호점');
insert into branch (id, branch_name) values (14,'서울숲점');
insert into branch (id, branch_name) values (15,'서초점');
insert into branch (id, branch_name) values (16,'선릉1호점');
insert into branch (id, branch_name) values (17,'선릉2호점');
insert into branch (id, branch_name) values (18,'선정릉점');
insert into branch (id, branch_name) values (19,'성수점');
insert into branch (id, branch_name) values (20,'시청1호점');
insert into branch (id, branch_name) values (21,'시청2호점');
insert into branch (id, branch_name) values (22,'신논현1호점');
insert into branch (id, branch_name) values (23,'신사점');
insert into branch (id, branch_name) values (24,'여의도점');
insert into branch (id, branch_name) values (25,'역삼1호점');
insert into branch (id, branch_name) values (26,'역삼2호점');
insert into branch (id, branch_name) values (27,'역삼3호점');
insert into branch (id, branch_name) values (28,'역삼4호점');
insert into branch (id, branch_name) values (29,'영등포점');
insert into branch (id, branch_name) values (30,'용산1호점');
insert into branch (id, branch_name) values (31,'을지로점');
insert into branch (id, branch_name) values (32,'합정점');
insert into branch (id, branch_name) values (33,'홍대1호점');
insert into branch (id, branch_name) values (34,'홍대2호점');

insert into location (id, location) values (1,'강남∙신논현');
insert into location (id, location) values (2,'교대∙서초');
insert into location (id, location) values (3,'삼성');
insert into location (id, location) values (4,'서울숲∙성수');
insert into location (id, location) values (5,'시청∙을지로∙광화문');
insert into location (id, location) values (6,'신사');
insert into location (id, location) values (7,'여의도∙구로');
insert into location (id, location) values (8,'역삼∙선릉');
insert into location (id, location) values (9,'용산∙한남');
insert into location (id, location) values (10,'홍대∙합정');
